...
public class UploadQnImpl implements UploadStrategy {
    ...
    public UploadQnImpl(Context context) {
        ...
        mCompletionHandler = new UpCompletionHandler() {
            ...
            public void complete(String key, ResponseInfo info, JSONObject response) {
                ...
                if (uploadBean.getType()==UploadBean.IMG) {
                    //上传完成后把 压缩后的图片 删掉
    ...
    private void uploadNext() {
        ...
        if (bean.getType()== UploadBean.VIDEO){
            bean.setRemoteFileName(StringUtil.generateVideoPath());
            ...
            bean.setRemoteFileName(StringUtil.generateVoiceFileName());
        }
    ...
    private void upload(UploadBean bean) {
        if (bean != null && !TextUtils.isEmpty(mToken) && mCompletionHandler != null) {
            ...
            L.e("--上传--bean.getRemoteFileName()----"+bean.getRemoteFileName());
