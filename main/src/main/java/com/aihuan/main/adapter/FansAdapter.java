...
public class FansAdapter extends RefreshAdapter<UserBean> {
    ...
    public FansAdapter(Context context) {
        ...
        mMsgClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!canClick()) {
                    return;
                ...
                UserBean bean = (UserBean) tag;
                if (mActionListener != null) {
                    mActionListener.onMsgClick(bean);
                }
            }
        };
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            ...
            mBtnMsg = itemView.findViewById(R.id.btn_pri_msg);
            mVip = itemView.findViewById(R.id.vip);
            mBtnMsg.setOnClickListener(mMsgClickListener);
