...
import com.aihuan.main.views.SubcribeAncViewHolder;
 ...
 */
public class SubcribeAncActivity extends AbsActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_subcribe_anc;
    }
    ...
    protected void main() {
        ...
        final String[] titles = new String[]{WordUtil.getString(R.string.chat_subcribe_me), WordUtil.getString(R.string.chat_subcribe_me_2)};
    ...
    private void loadPageData(int position) {
        ...
        if (vh == null) {
            if (mViewList != null && position < mViewList.size()) {
                ...
                if (position == 0) {
                    vh = new SubcribeAncViewHolder(mContext, parent);
                } else if (position == 1) {
                    vh = new SubcribeAudViewHolder(mContext, parent);
                }
                if (vh == null) {
                    return;
                }
