...
import com.aihuan.common.custom.VerticalViewPager;
...
import com.aihuan.main.views.UserHomeSecondViewHolder;
        ...
        if (vh == null) {
            if (mViewList != null && position < mViewList.size()) {
                ...
                if (position == 0) {
                    ...
                    mSecondViewHolder = new UserHomeSecondViewHolder(mContext, parent, mToUid);
