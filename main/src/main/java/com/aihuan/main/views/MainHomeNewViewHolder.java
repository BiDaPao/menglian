...
import com.aihuan.main.adapter.MainHomeNewAdapter;
    ...
    public void init() {
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<ChatLiveBean>() {
            ...
            public RefreshAdapter<ChatLiveBean> getAdapter() {
                if (mAdapter == null) {
                    mAdapter = new MainHomeNewAdapter(mContext);
                ...
                mAdapter.setOnAccostClick(new OnAccostClick() {
                    ...
                    public void onAccostClick(ChatLiveBean bean) {
                        MainHomeNewViewHolder.this.onAccostClick(bean);
                    }
                });
                return mAdapter;
            }
            ...
            public void loadData(int p, HttpCallback callback) {
                MainHttpUtil.getNew(p, mSex, callback);
            }
