...
public class MobBean {
    ...
    public static List<MobBean> getLoginTypeList(String[] types) {
        ...
        String login = WordUtil.getString(R.string.login);
        MobBean phoneBean = new MobBean();
        phoneBean.setType(Constants.MOB_PHONE);
        phoneBean.setIcon1(R.mipmap.icon_login_phone);
        phoneBean.setTip(WordUtil.getString(R.string.mob_phone) + login);
        list.add(phoneBean);
        if (types != null) {
            for (String type : types) {
                ...
                switch (type) {
                    case Constants.MOB_QQ:
                        ...
                        bean.setTip(WordUtil.getString(R.string.mob_qq) + login);
                        break;
                    case Constants.MOB_WX:
                        bean.setIcon1(R.mipmap.icon_login_wx);
                        bean.setTip(WordUtil.getString(R.string.mob_wx) + login);
                        break;
                    case Constants.MOB_FACEBOOK:
                        bean.setIcon1(R.mipmap.icon_login_fb);
                        bean.setTip(WordUtil.getString(R.string.mob_fb) + login);
                        break;
                    case Constants.MOB_TWITTER:
                        bean.setIcon1(R.mipmap.icon_login_tt);
                        bean.setTip(WordUtil.getString(R.string.mob_tt) + login);
                        break;
                }
                list.add(bean);
            }
