...
public class UploadVoiceImpl implements UploadStrategy {
    ...
    public UploadVoiceImpl(Context context) {
        mContext = context;
    ...
    private void uploadNext() {
        ...
        bean.setRemoteFileName(StringUtil.generateVoiceM4aFileName());
        if (mNeedCompress) {
