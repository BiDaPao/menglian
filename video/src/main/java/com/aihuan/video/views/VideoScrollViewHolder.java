...
import com.aihuan.video.adapter.VideoScrollAdapter;
import com.aihuan.video.bean.VideoBean;
import com.aihuan.video.custom.VideoLoadingBar;
...
public class VideoScrollViewHolder extends AbsViewHolder implements
    ...
    public void onImMessageBean(ImMessageBean bean) {
        ...
        if (!TextUtils.isEmpty(toUid) && toUid.equals(bean.getUid())) {
            ...
            if (giftBean != null) {
                ((AbsVideoPlayActivity) mContext).showGift(bean.getGiftBean());
            }
        }
    }
