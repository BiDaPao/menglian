...
import com.aihuan.one.activity.LiveAddImpressActivity;
...
public class LiveAddImpressViewHolder extends AbsLivePageViewHolder {
    ...
    public void init() {
        ...
        mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImpressTextView mtv = (ImpressTextView) v;
                if (!mtv.isChecked()) {
    ...
    private void initData() {
        OneHttpUtil.getAllImpress(mToUid, new HttpCallback() {
            @Override
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    while (hasNext) {
                        ...
                        for (int i = fromIndex; i < endIndex; i++) {
                            ImpressTextView item = (ImpressTextView) mInflater.inflate(R.layout.view_impress_item, linearLayout, false);
    ...
    private void save() {
        ...
        OneHttpUtil.setImpress(mToUid, ids, mHttpCallback);
    }
